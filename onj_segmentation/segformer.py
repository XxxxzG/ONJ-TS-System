"""refer to https://towardsdatascience.com/implementing-segformer-in-pytorch-8f4705e2ed0e"""
...
class SegFormerSegmentationHead(nn.Module):
    def __init__(self, channels: int, num_classes: int, num_features: int = 4):
        ...
        self.predict = nn.ConvTranspose2d(channels, num_classes, kernel_size=4, stride=4)
